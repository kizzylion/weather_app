...
function _renderData() {
  _renderData = renderData_asyncToGenerator( /*#__PURE__*/renderData_regeneratorRuntime().mark(function _callee(data) {
    var main, city, country, date, time, currentWeatherIcon, weatherCondition, weatherTemperature, degreeForm, degree, windSpeed, humidity, feelsLike, winddir, pressure, uv, precipitation, highlow, illumination, moonPhase, moonset, conditionImgRequest, video, playVideo;
