...
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28100);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
              ...
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return fetch(hour.forecast.forecastday[0].hour[i].condition.icon).then(function (response) {
                    ...
                    list.innerHTML = "\n        <p>".concat((0,date_fns__WEBPACK_IMPORTED_MODULE_0__/* .format */ .GP)(new Date(hour.forecast.forecastday[0].hour[i].time), "h a"), "</p>\n        <p>\n          <img src=").concat(imgUrl, " class=\"hourlyImg mx-auto w-fill object-contain backdrop-blur-0\" alt=\"\">\n        </p>\n        <p class=\"font-medium\">").concat((0,_renderData__WEBPACK_IMPORTED_MODULE_1__/* .returnSelectedDegree */ .w)(hour.forecast.forecastday[0].hour[i].temp_c, hour.forecast.forecastday[0].hour[i].temp_f), "</p>\n        ");
          ...
          i = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__/* .format */ .GP)(new Date(), "H");
        case 4:
          if (!(i < 24)) {
            _context2.next = 9;
            break;
              ...
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return fetch(data.forecast.forecastday[i].day.condition.icon).then(function (response) {
                    ...
                    list.innerHTML = "\n        <div class=\"text-left\">\n            <p>Today</p>\n            <p class=\"text-xs text-white/70\">May 11</p>\n        </div>\n        <p>\n            <img src=".concat(imgUrl, " class=\"hourlyImg mx-auto w-fill object-contain backdrop-blur-0\" alt=\"\">\n        </p>\n        <p class=\"flex items-center flex-nowrap  text-xs md:text-2xl font-bold \">").concat((0,_renderData__WEBPACK_IMPORTED_MODULE_0__/* .returnSelectedDegree */ .w)(data.forecast.forecastday[i].day.mintemp_c), "  <span class=\"inline-block min-w-4 w-full max-w-6 h-1 mx-auto rounded-md dayGradient\"></span>  ").concat((0,_renderData__WEBPACK_IMPORTED_MODULE_0__/* .returnSelectedDegree */ .w)(data.forecast.forecastday[i].day.maxtemp_c), " </p>\n      ");
...
/* harmony import */ var _fetchWeatherData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3057);
/* harmony import */ var _renderData__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(57041);
/* harmony import */ var _createHomepage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28018);
/* harmony import */ var _createHourlySection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(98361);
/* harmony import */ var _dailyForcastSection__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41167);
...
(0,_createHomepage__WEBPACK_IMPORTED_MODULE_1__/* .createHomepage */ .F)();
(0,_createHourlySection__WEBPACK_IMPORTED_MODULE_2__/* .createHourlyInfo */ .s)();
(0,_dailyForcastSection__WEBPACK_IMPORTED_MODULE_3__/* .createDailyInfo */ .g)();
var currentLocationData = await (0,_getCurrentLocation__WEBPACK_IMPORTED_MODULE_4__/* .getCurrentLocation */ .L)().then(function (position) {
  ...
  return (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_5__/* .getPositionWeatherData */ ._A)(position);
...
var defaultLocationData = await (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_5__/* .getCityWeatherData */ .uG)("London");
console.log(defaultLocationData);
if (currentLocationData) {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_6__/* .renderData */ .r)(currentLocationData);
} else {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_6__/* .renderData */ .r)(defaultLocationData);
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   r: () => (/* binding */ renderData),
/* harmony export */   w: () => (/* binding */ returnSelectedDegree)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28100);
/* harmony import */ var _createHourlySection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98361);
/* harmony import */ var _dailyForcastSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(41167);
...
function renderData(data) {
  ...
  var currentWeatherIcon = document.querySelector(".weathericon img");
  var weatherCondition = document.querySelector(".weathercondition");
  var weatherTemperature = document.querySelector(".temp");
  var degree = document.querySelector("#degree");
  var windSpeed = document.querySelector("#currentDetail .windspeed");
  var humidity = document.querySelector("#currentDetail .humidity .text");
  var feelsLike = document.querySelector("#currentDetail .feelike .text");
  var winddir = document.querySelector("#currentDetail .winddir .text");
  var pressure = document.querySelector("#currentDetail .pressure .text");
  var uv = document.querySelector("#currentDetail .uv .text");
  var precipitation = document.querySelector("#currentDetail .precipitation .text");
  var highlow = document.querySelector("#currentDetail .highlow .text");

  //moon section of forecast
  var illumination = document.querySelector("#forecast #moon .illuminationvalue");
  var moonPhase = document.querySelector("#forecast #moon .moonphase");
  var moonset = document.querySelector("#forecast #moon .moonsettime");
  city.innerText = data.location.name;
  country.innerText = data.location.country;
  date.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__/* .format */ .GP)(new Date(data.location.localtime), "MMM dd, yyyy");
  time.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__/* .format */ .GP)(new Date(data.location.localtime), "h:mm a");
  ...
  var conditionImgRequest = fetch(data.current.condition.icon).then(function (response) {
    return response.blob();
  }).then(function (myBlob) {
  ...
  //hourly section
  (0,_createHourlySection__WEBPACK_IMPORTED_MODULE_1__/* .createHourlyInfo */ .s)(data);

  //daily section
  (0,_dailyForcastSection__WEBPACK_IMPORTED_MODULE_2__/* .createDailyInfo */ .g)(data);
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [983], () => (__webpack_require__(44497)))
