...
/* harmony import */ var _getCurrentLocation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(85439);
/* harmony import */ var _fetchWeatherData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3057);
/* harmony import */ var _renderData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18130);
/* harmony import */ var _createHomepage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28018);
...
(0,_createHomepage__WEBPACK_IMPORTED_MODULE_2__/* .createHomepage */ .F)();
var currentLocationData = await (0,_getCurrentLocation__WEBPACK_IMPORTED_MODULE_3__/* .getCurrentLocation */ .L)().then(function (position) {
  console.log("Position:", position);
  return (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_4__/* .getPositionWeatherData */ ._A)(position);
...
var SearchData;
var defaultLocationData = await (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_4__/* .getCityWeatherData */ .uG)("London");
console.log(defaultLocationData);
if (currentLocationData) {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_1__/* .renderData */ .rb)(currentLocationData);
} else {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_1__/* .renderData */ .rb)(defaultLocationData);
}
...
function transformDate(dateStr, pattern) {
  try {
    ...
    console.log((0,format/* format */.GP)(date, pattern));
