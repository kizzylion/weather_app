...
/* harmony import */ var _getCurrentLocation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(85439);
/* harmony import */ var _fetchWeatherData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3057);
/* harmony import */ var _renderData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18130);
...
var currentLocationData = await (0,_getCurrentLocation__WEBPACK_IMPORTED_MODULE_2__/* .getCurrentLocation */ .L)().then(function (position) {
  console.log("Position:", position);
  return (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_3__/* .getPositionWeatherData */ ._A)(position);
...
var defaultLocationData = await (0,_fetchWeatherData__WEBPACK_IMPORTED_MODULE_3__/* .getCityWeatherData */ .uG)("London");
console.log(defaultLocationData);
if (currentLocationData) {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_4__/* .renderData */ .r)(currentLocationData);
} else {
  (0,_renderData__WEBPACK_IMPORTED_MODULE_4__/* .renderData */ .r)(defaultLocationData);
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  r: () => (/* binding */ renderData),
  w: () => (/* binding */ returnSelectedDegree)
});

// EXTERNAL MODULE: ./node_modules/date-fns/format.mjs + 34 modules
var format = __webpack_require__(28100);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          i = (0,format/* format */.GP)(new Date(), "H");
        case 4:
          if (!(i < 24)) {
            _context2.next = 9;
            break;
    ...
    return renderData_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          date.innerText = (0,format/* format */.GP)(new Date(data.location.localtime), "MMM dd, yyyy");
          time.innerText = (0,format/* format */.GP)(new Date(data.location.localtime), "h:mm a");
